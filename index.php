...
<head>
  ...
  <style>
    :root{
      --brand:   #756ba4ff;   /* verde principal */
      --brand-2: #9a9dd6ff;   /* acento */
    ...
    .btn-primary{ --bs-btn-bg:var(--brand); --bs-btn-border-color:var(--brand); --bs-btn-hover-bg:#0EfF45; --bs-btn-hover-border-color:#0E3F85; --bs-btn-active-bg:#0B352C; --bs-btn-active-border-color:#0B352C;}
...
<body>
  ...
  <main class="container py-4">
    ...
    <p class="text-center text-muted mt-4">
      Hecho con ❤ en PHP 8 + SQLite + Bootstrap por @desaextremo...
    </p>
  </main>
</body>
</html>
